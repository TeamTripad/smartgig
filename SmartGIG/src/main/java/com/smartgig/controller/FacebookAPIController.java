...
import com.smartgig.site.dto.AccessTokenResponseFacebook;
import com.smartgig.site.dto.FacebookBasicProfile;
...
//		
//			String graph = null;
//			String g = "https://graph.facebook.com/me?fields=id,name,first_name,last_name," + "birthday,gender,email&"
//					+ access;
//
//			URL u = new URL(g);
...
//		String fbGraphUrl = "";
//
//		fbGraphUrl = "https://graph.facebook.com/oauth/access_token?" + "client_id=" + client_id + "&redirect_uri="
...
//	 String access_token = 
	 ...
	 Request requestAT = new Request.Builder()
	...
	// .url("https://graph.facebook.com/oauth/access_token?"
	 ...
	 AccessTokenResponseFacebook atrf = mapperInfo.readValue(respBodyAT,
	 AccessTokenResponseFacebook.class);
	 ...
	 FacebookBasicProfile fbp = mapperInfo.readValue(respBodyInfo,
	 FacebookBasicProfile.class);
